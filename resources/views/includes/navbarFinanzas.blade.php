...
<input type="checkbox" id="checkk">
     ...
     <div class="barraMenu">
      ...
      @endif
            ...
            <a href="/FinanzasIngresos"> <i class="bi bi-clipboard-data"></i></i><span>Ingresos</span></a>
            <a href="/FinanzasEgresos"> <i class="bi bi-clipboard-minus-fill"></i></i><span>Egresos</span></a>
            <a href="/FinanzasIngresosEgresos"> <i class="bi bi-circle-half"></i></i><span>Ingresos y Egresos</span></a>
        </div>
